...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/Mathine/Library.js"></script>
  </head>
  
  <body>
   	<div class="functiondiv">
   		<div>
       		<a href="javascript:addlibrary()" class="easyui-linkbutton" iconCls="icon-newadd">新增</a>
		</div>
   	</div>
    <div id="body">
		...
		<div id="dlg" class="easyui-dialog" style="width: 400px; height: 500px; padding:10px 20px" closed="true" buttons="#dlg-buttons">
			<form id="fm" class="easyui-form" method="post" data-options="novalidate:true"><br/>
				<div class="fitem">
    				...
    				<input class="easyui-textbox" name="mvaluename" id="mvaluename"/>
    			</div>
    			<div class="fitem">
    				<lable><span class="required">*</span>等级</lable>
		...
		<div id="rdlg" class="easyui-dialog" style="width: 400px; height: 500px; padding:10px 20px" closed="true" buttons="#remove-buttons">
			<form id="rfm" class="easyui-form" method="post" data-options="novalidate:true"><br/>
				<div class="fitem">
    				...
    				<lable><span class="required">*</span>焊接方法</lable>
    				<input class="easyui-textbox" name="mvaluename" id="mvaluename" readonly="readonly"/>
    			</div>
    			<div class="fitem">
    				<lable><span class="required">*</span>等级</lable>
			    	<input name="model" id="model" class="easyui-textbox" readonly="true"/>
    			</div>
			</form>
		</div>
