...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js//datastatistics/machinetask.js"></script>
  </head>
		...
		<div id="chartLoading" style="width:100%;height:100%;">
	  	...
	  	<div id="dg_btn">
			<div style="margin-bottom: 5px;">
				...
				<input class="radioStyle" type="radio" value="1" name="status" id="status" checked="checked">未分配
				<input class="radioStyle" type="radio" value="2" name="status" id="status">已分配
				<input class="radioStyle" type="radio" value="0" name="status" id="status">全部
